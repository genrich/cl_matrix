...
find_path(OCTAVE_INCLUDE_DIR oct.h ${OCTAVE_INCLUDE_PATHS} ${OCTAVE_INCLUDE_PATHS})
...
if(OCTAVE_FOUND)
    set(OCTAVE_LIBRARIES ${OCTAVE_OCTAVE_LIBRARY} ${OCTAVE_OCTINTERP_LIBRARY})
    set(OCTAVE_INCLUDE_DIRS ${OCTAVE_INCLUDE_DIR})
endif()

mark_as_advanced(OCTAVE_OCTINTERP_LIBRARY OCTAVE_OCTAVE_LIBRARY OCTAVE_INCLUDE_DIR)
